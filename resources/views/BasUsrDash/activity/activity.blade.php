            ...
            <div class="col-md-6 m-auto">
                ...
                <div>
                    <table>
                        ...
                        <tr>
                            <td><a href="{{ route('blog.details', ['post_name' => $blog->slug]) }}">{{ Str::limit($blog->blog_name,35, '...') }}</a></td>
                            <td>
                    ...
                    @foreach ($comments as $comment)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('blog.details', ['post_name' => $slub]) }}" class="btn btn-danger btn-sm">View</a>
                            </td>
                        </tr>
                    @endforeach
                </table>
