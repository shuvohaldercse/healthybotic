                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('basUser.becomeBloggerInsertBlog') }}" method="POST"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('blogTags') is-invalid @enderror"
                                            value="{{ old('blogTags') }}" data-role="tagsinput"
                                            placeholder="Tags, seperate by ( , )" name="blogTags" id="blogTags">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="blogMeta"
                                            ...
                                            value="{{ old('blogMeta') }}" name="blogMeta"
                                            placeholder="SEO Blog Meta Title">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea placeholder="SEO Blog Meta Description" class="form-control @error('blogMetaDesc') is-invalid @enderror"
                                            name="blogMetaDesc" id="blogMetaDesc"></textarea>
