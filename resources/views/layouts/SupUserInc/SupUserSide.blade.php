    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('supuser.dashboard') ? '' : 'active' }}"
                    href="{{ route('supuser.dashboard') }}">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-menu-button-wide"></i><span>Post Article</span><i
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-journal-text"></i><span>Pending Article <b
                            style="color:red;">{{ $pendingPost }}</b></span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{ route('supuserBlog.pendingBlog') }}">
                            <i class="bi bi-circle"></i><span>Pending Article <b
                                    style="color:red;">{{ $pendingPost }}</b> </span>
                        </a>
                    </li>
            ...
            <li class="nav-item">
                ...
                <ul id="users-nav"
                    class="nav-content collapse {{ Request::is('supuser.listuser') || Request::is('blogger.datatable.listuser') ? ' show' : '' }}"
                    data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{ route('supuser.listuser') }}"
                            class="{{ Request::is('supuser.listuser') ? ' active' : '' }}">
            ...
            <li class="nav-heading">CybSam-Development</li>
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#cybsamdev-nav" data-bs-toggle="collapse"
                    href="#">
                    <i class="bi bi-gear"></i><span>CybSam-Development</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="cybsamdev-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{ route('cybsamdev.optimize') }}">
                            <i class="bi bi-circle"></i><span>Website Optimize</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('cybsamdev.clearcache') }}">
                            <i class="bi bi-circle"></i><span>Website Cache Clear</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('cybsamdev.routecache') }}">
                            <i class="bi bi-circle"></i><span>Website Route Clear</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('cybsamdev.configcache') }}">
                            <i class="bi bi-circle"></i><span>Website Config Cache</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('cybsamdev.viewclear') }}">
                            <i class="bi bi-circle"></i><span>Website View Clear</span>
                        </a>
                    </li>
