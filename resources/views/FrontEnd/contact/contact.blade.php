                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                                <span>
                                    ...
                                    <a href="mailto:">mail@healthybotic.com</a>
                                </span>
                            ...
                            <li>
                                <span>
                                    ...
                                    <a href="#" target="_blank"> www.healthybotic.com</a>
                                </span>
                            </li>
                        </ul>
                        ...
                        <div class="social__media">
                            ...
                            @endphp
                                <li class="list-inline-item">
                                    <a href="{{ $findUs->facebook }}" class="btn btn-social rounded text-white facebook">
                                        <i class="fa fa-facebook"></i>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="{{ $findUs->twitter }}" class="btn btn-social rounded text-white twitter">
                                        <i class="fa fa-twitter"></i>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="tel:{{ $findUs->whatsapp }}" class="btn btn-social rounded text-white whatsapp">
                                        <i class="fa fa-whatsapp"></i>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="{{ $findUs->telegram }}" class="btn btn-social rounded text-white telegram">
                                        <i class="fa fa-telegram"></i>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="{{ $findUs->linkedin }}" class="btn btn-social rounded text-white linkedin">
